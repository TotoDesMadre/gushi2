...
export const Home = () => {
  ...
  const { ref: section2, inView: elementIsVisible } = useInView({
    triggerOnce: true,
    threshold: 0.5,
  });
  ...
  if (!auth) {
    ...
    return (
      <div className="container-fluid p-0 ">
              ...
              <div className="row d-flex align-items-center">
                ...
                >
                  <Transform enterTransform="translateX(40px)" in>
                    ...
                    <h2>
                      Story Time is a fun and innovative way to help trigger
                      yours
        ...
        <div className="row">
          <div ref={section2} className="secondSection">
            <div>
                ...
                <div className={`${elementIsVisible ? "box1" : ""}`}>
                  ...
                  <div className="col-xl-7">
                    <div className="content d-flex flex-column justify-content-center ps-0 ps-xl-4">
                      <h1 style={{ color: "#3a556e" }}>Testing text</h1>

                      {/* Moved pronounciation to a file called audio.js */}
                      <Audio />
                    </div>
                  </div>
                </div>
